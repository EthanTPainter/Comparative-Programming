...
#checks if the files have the correct extensions and decide to encrypt or decrypt
def checkEncOrDec():
...
#Read 64 bit blocks and encrypt or decrypt in CFB then write to file out
